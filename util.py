...
if __name__=='__main__':
    ...
    #print(classify_image(classify_image(get_cropped_image_if_2_eyes)))
    #print(classify_image(None, "model/test_images/fedrer2.jpg"))
   # print(classify_image(None, "model/test_images/MS_Federer_Roger_CloseUp.jpg"))
    #print(classify_image(None, "model/test_images/kohli.jpg"))
    #print(classify_image(None, "model/test_images/messi.jpg"))
    ...
    #print(classify_image(None, "model/test_images/photo.jpg"))
    # print(classify_image(None, "./test_images/serena2.jpg"))
   # print(classify_image(None, "model/test_images/sharapova1.jpg"))
